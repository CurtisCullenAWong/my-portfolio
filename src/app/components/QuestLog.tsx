...
const projects = [
  {
    title: "Vista AIMS",
    subtitle: "Academic Information Management",
    description: "A comprehensive academic information management system built to streamline institutional workflows, manage student records, and facilitate administrative processes at scale.",
  ...
  },
  {
    ...
    description: "An advanced pricing engine and matrix calculator for logistics and shipping coordination, enabling real-time dynamic rate adjustments across carrier networks.",
  ...
  {
    title: "BCE ATS Website",
    subtitle: "Company Website",
    description: "A digital tracking and logistics portal allowing users to monitor shipments in real-time with multi-stage delivery statuses and integrated carrier notifications.",
  ...
  {
    title: "EasyTrack",
    subtitle: "Remote Team Productivity Suite",
    description: "An intuitive task management and time-tracking suite designed for remote developer teams, featuring productivity analytics and sprint reporting dashboards.",
  ...
  },
  {
    ...
    subtitle: "AI-Powered Playlist Curation",
    description: "An LLM-powered application that curates, analyzes, and generates deeply descriptive Spotify playlists tailored to specific moods, activities, and sonic aesthetics.",
    tags: ["Next.js", "Spotify API", "Ollama"],
    status: "In Progress",
    url: "#",
